...
var CustomerRestController = (function () {
    function CustomerRestController() {
        ...
        this.customerService = new customer_service_1.CustomerService(this.customerRepository);
    }
    ...
    CustomerRestController.prototype.getCustomer = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var customerId, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.customerService.getCustomer(customerId)];
                    case 1:
                        data = _a.sent();
                        res.status(axios_1.HttpStatusCode.Ok).json({
                            status: 'SUCCESS',
    ...
    return CustomerRestController;
}());
exports.default = CustomerRestController;
//# sourceMappingURL=customer.controller.rest.js.map