...
var DriverRepository = (function () {
    ...
    DriverRepository.prototype.getDriver = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, prisma_1.default.driver.findUnique({
                            where: {
                                id: id
                            },
                            include: {
    ...
    DriverRepository.prototype.getListDrivers = function (filter) {
        return __awaiter(this, void 0, void 0, function () {
            var where;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, prisma_1.default.driver.findMany({
                                where: where,
                                include: {
                                    user: true
                                }
    ...
    DriverRepository.prototype.getAvailableDrivers = function (vehicleType) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
