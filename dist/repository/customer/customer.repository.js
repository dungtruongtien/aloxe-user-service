...
exports.CustomerRepository = exports.CustomerStatusEnum = exports.CustomerRoleEnum = void 0;
...
var CustomerRepository = (function () {
    ...
    CustomerRepository.prototype.getListCustomers = function (filter) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, prisma_1.default.customer.findMany({
                                where: where,
                                include: {
                                    user: true
                                }
