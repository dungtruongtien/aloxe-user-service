...
var UserRepository = (function () {
    ...
    UserRepository.prototype.getListUsers = function (filter) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        where = {};
                        if ((filter === null || filter === void 0 ? void 0 : filter.phoneNumbers) && filter.phoneNumbers.length > 0) {
                            where.phoneNumber = {
                                in: filter.phoneNumbers
                            };
                        }
                        if ((filter === null || filter === void 0 ? void 0 : filter.userIds) && filter.userIds.length > 0) {
                            where.id = {
                                in: filter.userIds
                            };
                        }
                        ...
                        return [4, prisma_1.default.user.findMany({
                                where: where,
                                include: {
                                    staff: true,
                                    driver: true,
