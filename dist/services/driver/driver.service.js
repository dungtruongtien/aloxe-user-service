...
var DriverService = (function () {
    ...
    DriverService.prototype.getListDrivers = function (filter) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.driverRepo.getListDrivers(filter)];
                    case 1:
                        data = _a.sent();
                        return [2, data];
                }
    ...
    DriverService.prototype.getAvailableDrivers = function (vehicleType) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.driverRepo.getAvailableDrivers(vehicleType)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
